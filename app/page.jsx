      ...
      <div className="flex w-full">
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 w-full">
            ...
            {/* KPIs (full width, auto-responsive) */}
            ...
            <div className="xl:col-span-2 card p-4 flex flex-col gap-4">
              ...
              {/* Charts under map (stack on mobile) */}
        ...
        {/* RIGHT PANEL */}
        <aside className="w-[320px] border-l border-white/10 bg-black/20 backdrop-blur p-4 hidden lg:block">
          <RightPanel />
        </aside>
      </div>
    </div>
